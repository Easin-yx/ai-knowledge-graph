...
const aiGraphData: GraphData = {
  nodes: [
    ...
    },
    {
      ...
      details: {
        zh_label: "Claude",
        summary: "Anthropic 研发的大语言模型系列，以长上下文、强推理与编码能力，以及基于「宪法 AI」的对齐安全性著称。",
        analogy: "像一位特别讲原则、又博学的资深顾问：不只答得好，还会按一套既定的价值准则自我约束，尽量稳妥可靠。",
        notes: "代表模型如 Claude 3 / 3.5（Haiku/Sonnet/Opus 分档）。Anthropic 提出「Constitutional AI」，用一套书面原则让模型自我批评修正，减少对大量人工标注的依赖。它是 GPT 之外主流的闭源大模型之一，也是本项目所用的模型家族。",
        key_concepts: ["Anthropic", "宪法 AI 对齐", "长上下文", "强编码/推理"],
    ...
    },
    {
      ...
      details: {
        zh_label: "Midjourney",
        summary: "Midjourney 公司推出的文生图产品，以高度艺术化、风格统一的画面质感著称，早期主要通过 Discord 机器人交互使用。",
        analogy: "像一位风格强烈的签约画师：你给个主题，他总能产出审美在线、气质独特的作品，哪怕你不太会描述细节。",
        notes: "闭源商业产品，底层基于扩散模型；以出色的默认美学和易用性广受设计/创意领域欢迎。与 Stable Diffusion（开源可自部署）、DALL·E（OpenAI）并列为主流文生图工具。",
        key_concepts: ["文生图产品", "艺术化美学", "Discord 交互", "闭源商业"],
    ...
    },
    {
      ...
      details: {
        zh_label: "DALL·E",
        summary: "OpenAI 的文生图模型系列，能根据自然语言描述生成图像，DALL·E 3 深度集成 ChatGPT、对长提示的理解尤为出色。",
        analogy: "像一位特别「懂话」的插画师：你用大白话描述一长串细节，他都能准确听懂并画对，几乎不用反复纠正。",
        notes: "DALL·E（2021）首次惊艳展示文生图能力，DALL·E 2 用 CLIP 引导 + 扩散，DALL·E 3 强化了对复杂/长文本提示的遵循并接入 ChatGPT。是文生图赛道的代表性产品之一。",
        key_concepts: ["OpenAI", "文生图", "强提示遵循", "接入 ChatGPT"],
  ...
  edges: [
    ...
    {
      id: "machine_learning__前置步骤__feature_engineering",
      source: "machine_learning",
    ...
    {
      id: "llm__压缩技术__knowledge_distillation",
      source: "llm",
      target: "knowledge_distillation",
      label: "压缩技术",
    },
    {
      id: "knowledge_distillation__同属模型压缩__quantization",
    ...
    // ═══ 批次 15 — optional 收尾 ═════════════════
    {
      id: "machine_learning__训练配置__hyperparameter_tuning",
      source: "machine_learning",
    ...
    {
      id: "llm__推理加速__speculative_decoding",
      source: "llm",
      target: "speculative_decoding",
      label: "推理加速",
    },
    {
      id: "speculative_decoding__同属推理优化__kv_cache",
