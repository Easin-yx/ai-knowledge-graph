...
export const HUMANOID_ROBOT_TAXONOMY: TaxonomyDomain[] = [
  {
    domain: "0. 根节点",
    topics: [
      { id: "humanoid_robot", label: "人形机器人", priority: "core" },
    ],
  },
  {
    domain: "1. 核心技术",
    topics: [
      { id: "core_technology",           label: "核心技术",     priority: "core" },
      { id: "environmental_perception",  label: "环境感知",     priority: "core" },
      { id: "motion_control_planning",   label: "运动控制与规划", priority: "core" },
      { id: "embodied_ai_models",        label: "具身AI大模型", priority: "core" },
      { id: "hri",                       label: "人机交互",     priority: "core" },
      { id: "slam",                      label: "SLAM",        priority: "recommended" },
      { id: "vision_3d",                 label: "3D视觉感知",   priority: "recommended" },
      { id: "multimodal_perception",     label: "多模态感知融合", priority: "recommended" },
      { id: "tactile_feedback_processing", label: "触觉反馈处理", priority: "recommended" },
      { id: "gait_planning",             label: "步态规划",     priority: "recommended" },
      { id: "wbc",                       label: "全身控制（WBC）", priority: "recommended" },
      { id: "mpc",                       label: "模型预测控制（MPC）", priority: "recommended" },
      { id: "rl_control",                label: "强化学习控制", priority: "recommended" },
      { id: "vla_models",                label: "视觉-语言-行动模型（VLA）", priority: "recommended" },
      { id: "generalized_grasping",      label: "通用抓取",     priority: "recommended" },
      { id: "physics_simulators",        label: "物理仿真器",   priority: "recommended" },
      { id: "synthetic_data_gen",        label: "合成数据生成", priority: "recommended" },
      { id: "nlu",                       label: "自然语言理解", priority: "optional" },
      { id: "intent_recognition",        label: "意图识别",     priority: "optional" },
      { id: "affective_computing",       label: "情感计算",     priority: "optional" },
      { id: "speech_synthesis",          label: "语音合成",     priority: "optional" },
    ],
  },
  {
    domain: "2. 硬件组件",
    topics: [
      { id: "hardware_component",        label: "硬件组件",     priority: "core" },
      { id: "actuator_system",           label: "执行器系统",   priority: "core" },
      { id: "core_parts",                label: "核心零部件",   priority: "core" },
      { id: "sensory_system",            label: "感知系统",     priority: "core" },
      { id: "compute_power",             label: "算力与能源",   priority: "core" },
      { id: "rotary_actuators",          label: "旋转执行器",   priority: "recommended" },
      { id: "linear_actuators",          label: "线性执行器",   priority: "recommended" },
      { id: "dexterous_hands",           label: "灵巧手",       priority: "recommended" },
      { id: "bionic_joints",             label: "仿生关节",     priority: "recommended" },
      { id: "harmonic_reducers",         label: "谐波减速器",   priority: "recommended" },
      { id: "planetary_roller_screws",   label: "行星滚柱丝杠", priority: "recommended" },
      { id: "frameless_torque_motors",   label: "无框力矩电机", priority: "recommended" },
      { id: "six_axis_force_sensors",    label: "六维力矩传感器", priority: "recommended" },
      { id: "tactile_sensors_eskin",     label: "触觉传感器/电子皮肤", priority: "recommended" },
      { id: "rgbd_cameras",              label: "RGB-D深度相机", priority: "recommended" },
      { id: "imu",                       label: "惯性测量单元（IMU）", priority: "recommended" },
      { id: "edge_computing_chips",      label: "边缘计算芯片", priority: "recommended" },
      { id: "high_density_battery",      label: "高能量密度电池", priority: "recommended" },
      { id: "planetary_reducers",        label: "行星减速器",   priority: "optional" },
      { id: "coreless_motors",           label: "空心杯电机",   priority: "optional" },
      { id: "ball_screws",               label: "滚珠丝杠",     priority: "optional" },
      { id: "lidar",                     label: "激光雷达",     priority: "optional" },
      { id: "internal_bus",              label: "内部总线",     priority: "optional" },
      { id: "bms",                       label: "电池管理系统（BMS）", priority: "optional" },
    ],
  },
  {
    domain: "3. 代表企业与产品",
    topics: [
      { id: "companies_and_products",    label: "代表企业与产品", priority: "core" },
      { id: "global_leaders",            label: "国际第一梯队",  priority: "core" },
      { id: "domestic_innovators",       label: "国内新锐",     priority: "core" },
      { id: "key_suppliers",             label: "核心供应商",   priority: "recommended" },
      { id: "tesla_company",             label: "特斯拉",       priority: "recommended" },
      { id: "boston_dynamics",           label: "波士顿动力",   priority: "recommended" },
      { id: "figure_ai",                 label: "Figure AI",   priority: "recommended" },
      { id: "agility_robotics",          label: "Agility Robotics", priority: "recommended" },
      { id: "unitree_robotics",          label: "宇树科技",     priority: "recommended" },
      { id: "agibot",                    label: "智元机器人",   priority: "recommended" },
      { id: "ubtech",                    label: "优必选",       priority: "recommended" },
      { id: "fourier_intelligence",      label: "傅利叶智能",   priority: "recommended" },
      { id: "limx_dynamics",             label: "逐际动力",     priority: "recommended" },
      { id: "tesla_optimus",             label: "Optimus",     priority: "optional" },
      { id: "bd_atlas",                  label: "Atlas",       priority: "optional" },
      { id: "figure_02",                 label: "Figure 02",   priority: "optional" },
      { id: "agility_digit",             label: "Digit",       priority: "optional" },
      { id: "unitree_h1_g1",             label: "H1/G1",       priority: "optional" },
      { id: "agibot_expedition",         label: "远征A1",       priority: "optional" },
      { id: "ubtech_walker",             label: "Walker S",    priority: "optional" },
      { id: "fourier_gr1",               label: "GR-1",        priority: "optional" },
    ],
  },
  {
    domain: "4. 应用场景",
    topics: [
      { id: "application_scenarios",     label: "应用场景",     priority: "core" },
      { id: "industrial_logistics",      label: "工业与物流",   priority: "core" },
      { id: "special_ops",               label: "特种作业",     priority: "core" },
      { id: "commercial_services",       label: "商业服务",     priority: "recommended" },
      { id: "home_services",             label: "家庭服务",     priority: "recommended" },
      { id: "material_handling",         label: "物料搬运",     priority: "recommended" },
      { id: "assembly_line",             label: "流水线装配",   priority: "recommended" },
      { id: "quality_inspection",        label: "质量检测",     priority: "optional" },
      { id: "warehouse_sorting",         label: "仓储分拣",     priority: "optional" },
      { id: "disaster_rescue",           label: "灾难救援",     priority: "recommended" },
      { id: "nuclear_inspection",        label: "核电巡检",     priority: "optional" },
      { id: "hazardous_handling",        label: "危险品处置",   priority: "optional" },
      { id: "space_exploration",         label: "太空探索",     priority: "optional" },
      { id: "medical_rehab",             label: "医疗康复",     priority: "recommended" },
      { id: "reception_guiding",         label: "接待导览",     priority: "optional" },
      { id: "retail_replenishment",      label: "零售补货",     priority: "optional" },
      { id: "elderly_care",              label: "养老陪护",     priority: "recommended" },
      { id: "home_cleaning",             label: "居家清洁",     priority: "optional" },
    ],
  },
  {
    domain: "5. 产业链",
    topics: [
      { id: "industry_chain",            label: "产业链",       priority: "core" },
      { id: "upstream",                  label: "上游：核心硬件与软件", priority: "core" },
      { id: "midstream",                 label: "中游：本体制造", priority: "core" },
      { id: "downstream",                label: "下游：系统集成与落地", priority: "core" },
      { id: "core_parts_mfg",            label: "核心零部件制造", priority: "recommended" },
      { id: "sensor_mfg",                label: "传感器制造",   priority: "recommended" },
      { id: "ai_chip_design",            label: "AI算力芯片设计", priority: "recommended" },
      { id: "sim_platform_dev",          label: "仿真平台开发", priority: "recommended" },
      { id: "data_annotation",           label: "数据标注服务", priority: "recommended" },
      { id: "robot_design",              label: "整机研发设计", priority: "recommended" },
      { id: "assembly_testing",          label: "整机组装测试", priority: "recommended" },
      { id: "automation_integration",    label: "工业自动化集成", priority: "recommended" },
      { id: "software_customization",    label: "软件应用二次开发", priority: "optional" },
      { id: "maintenance_service",       label: "售后维保服务", priority: "optional" },
      { id: "mechanical_processing",     label: "机械加工",     priority: "optional" },
    ],
  },
  {
    domain: "6. 产品评估与商业化",
    topics: [
      { id: "evaluation_commercialization", label: "产品评估与商业化", priority: "core" },
      { id: "core_metrics",              label: "核心产品指标", priority: "core" },
      { id: "bom_cost_mass_prod",        label: "BOM成本与量产分析", priority: "core" },
      { id: "commercialization_path",    label: "商业化路径与挑战", priority: "core" },
      { id: "dof",                       label: "自由度/DOF",   priority: "recommended" },
      { id: "payload",                   label: "有效负载能力", priority: "recommended" },
      { id: "max_walking_speed",         label: "最大步行速度", priority: "recommended" },
      { id: "battery_life",              label: "电池续航时间", priority: "recommended" },
      { id: "weight_dimensions",         label: "整机重量与尺寸", priority: "optional" },
      { id: "component_cost_breakdown",  label: "零部件成本占比", priority: "recommended" },
      { id: "scaling_reduction",         label: "规模化降本路径", priority: "recommended" },
      { id: "yield_rate",                label: "良品率控制",   priority: "optional" },
      { id: "supply_chain_maturity",     label: "供应链成熟度", priority: "recommended" },
      { id: "b2b_validation",            label: "B端场景商业验证", priority: "recommended" },
      { id: "data_scarcity",             label: "高质量数据集稀缺", priority: "recommended" },
      { id: "physical_safety",           label: "物理交互安全性", priority: "recommended" },
      { id: "legal_ethical",             label: "法律与伦理规范", priority: "optional" },
    ],
  },
];
...
export const TAXONOMY_REGISTRY: Record<string, TaxonomyDomain[]> = {
  ...
  "humanoid-robot": HUMANOID_ROBOT_TAXONOMY,
};
